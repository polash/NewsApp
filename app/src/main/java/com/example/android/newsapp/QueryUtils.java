...
public class QueryUtils {
    ...
    public static List<News> extractFeatureFromJson(String newsJSON){
        ...
        try {
            ...
            JSONObject articleFeeds = baseJSONResponse.optJSONObject("response");
            JSONArray resultsArray = articleFeeds.optJSONArray("results");

            for (int i = 0; i < resultsArray.length(); i++){
                JSONObject currentArticle = resultsArray.optJSONObject(i);
                ...
                News news = new News(title, topic, date, url);
                newses.add(news);
            }
    ...
    public static List<News> fetchArticleData (String requestURL){
        ...
        Log.i(LOG_TAG,"TEST: Earthquake Data fetch called...");
        // Create URL object
